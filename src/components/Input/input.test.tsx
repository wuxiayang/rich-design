...
describe('test Input component', ()=>{
    ...
    it('should render different input sizes or size property', ()=>{
        const wrapper = render(<Input placeholder="sizes" size="lg"/>)
        const testContainer = wrapper.container.querySelector('.rich-input-wrapper')
        expect(testContainer).toHaveClass('input-size-lg')
    })
    it('should render prepend and append element on prepend/append property', ()=>{
        const { queryByText, container } = render(<Input placeholder="pend" prepend="http://" append=".com"/>)
        const testContainer = container.querySelector('.rich-input-wrapper')
